...
public class MapController {
	...
	public String reAxis(HttpSession session, ModelMap model){
		String phone = (String)session.getAttribute(Constant.phone);
	...
	public String saveMap(@RequestParam("longitude") Float longitude, @RequestParam("latitude") Float latitude, HttpSession session){
		String phone = (String)session.getAttribute(Constant.phone);
		Shop shop = shopDao.getByPhone(phone);
		Map map = new Map();
		map.setShop_id(shop.getId());
