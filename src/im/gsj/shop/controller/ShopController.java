...
public class ShopController extends CommonController{
	...
	public String adminUpdatePassword(@RequestParam("phone") String phone, @RequestParam("newpassword") String newpassword, @RequestParam("repassword") String repassword, ModelMap model){
		String viewResult = "";
	...
	public String modPassword(HttpSession session, ModelMap model){
		String phone = (String)session.getAttribute(Constant.phone);
		//使头部能显示
